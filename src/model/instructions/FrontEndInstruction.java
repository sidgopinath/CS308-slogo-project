...
/**
 * Class which contains sprint 3's instructions, most of which involve interaction with the view.
 * Some have not been implemented due to complexities in
 * how the front end is laid out.
 **/
public class FrontEndInstruction extends Instruction {
    private static final double WINDOW_CONSTANT = 1;
    private static final double FENCE_CONSTANT = 3;
    ...
    public double execute () {
        switch (myInstructionType.toUpperCase()) {
            ...
            case "SETSHAPE":
                return myViewUpdater.setShape(myDependencies.get(0).execute(),
                                              myEnvironment.getActiveTurtle());
                // case "SETPALETTE":
                // return 0;
            case "GETPENCOLOR":
            ...
            case "WINDOW":
                return myEnvironment.setWindowBehavior(WINDOW_CONSTANT);
            case "FENCE":
                return myEnvironment.setWindowBehavior(FENCE_CONSTANT);
            default:
                return -1;
        }
    }
