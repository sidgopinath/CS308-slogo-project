...
/**
 * Main view class containing the menupane and tabpane, which do not change regardless of the number
 * of tabs/scenes added
 * 
...
public class MainView {
    ...
    public MainView (Stage s) {
        ...
        mySceneSetter.setupScene(myStage, grid, myDimensions.getWidth(), myDimensions.getHeight(),
                                 myResources);
    }
