...
public class SideBar extends VBox {
    ...
    private void createColumns () {
        TableColumn<Property, String> propertiesCol =
                new TableColumn<Property, String>(
                                                  myResources.getString("Properties"));
        TableColumn<Property, String> valuesCol =
                new TableColumn<Property, String>(
        ...
        valuesCol.setCellValueFactory(new PropertyValueFactory<Property, String>(
                                                                                 "myProperty"));
        propertiesCol.setPrefWidth(164); 
    ...
    private void createVariableColumns () {
        TableColumn<Property, String> variablesCol =
                new TableColumn<Property, String>(
                                                  myResources.getString("Variables"));
        TableColumn<Property, Double> valuesCol =
                new TableColumn<Property, Double>(
                                                  myResources.getString("Values"));
